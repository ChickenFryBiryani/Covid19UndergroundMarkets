...
def selenium_setup_firefox_network():
    ...
    aProfile.DEFAULT_PREFERENCES['frozen']['javascript.enabled'] = False  # manual javascript disabled its needed for genesis market
    ...
    aBrowserDriver = webdriver.Firefox(aProfile, executable_path='/home/rob/geckodriver-v0.25.0-linux64/geckodriver', log_path=os.devnull)
